...
Thus, we decided to carry out the downstream analysis, normalizing the coverage with the assumption that the distribution of all linked genes should have a mean equal to 1.
...
Two genes, {\footnotesize CT55} and {\footnotesize TCP11x2} are duplicated in full length on the annotation, but since they each have relatively low variances (2nd quartile of overall SD), they are not considered actively ampliconic. Nevertheless, the overlap of TCP11x2 and ENSPTRG00000048802 does fall above a median of 2. % TODO flyt længere ned
